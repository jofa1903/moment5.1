...
class Courses
{
    ...
    {
        $query = "SELECT * FROM  yofal_courses.courses";
    ...
    {
        $query = "SELECT * FROM yofal_courses.courses WHERE id = ?";
    ...
    {
        $query = "INSERT INTO yofal_courses.courses 
        SET
            code = :code,
            name = :name,
...
{
    $query = "UPDATE yofal_courses.courses 
    SET
        code = :code,
        name = :name,
        progression = :progression,
    ...
    public function delete()
    {
        if (isset($_GET['id'])) {
            ...
            $query = "DELETE FROM yofal_courses.courses WHERE id = $id";
            $stmt = $this->conn->prepare($query);
